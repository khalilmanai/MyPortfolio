...
const Contact = () => {
    return (
        <div name="contact" className='w-full h-screen sm: px-40 bg-[#0a192f] flex justify-center items-center p-4 '>
            <form method='POST' action='https://getform.io/f/80c5b892-1a13-4fa4-be51-4df14ab7a0e2' className='flex flex-col max-w-[600px] w-full'>
                <div className='pb-8 mt-7'>
                    ...
                    <p className='text-gray-300 py-4' > Sumbit the form below or get in touch with me on - myemail@gmail.com</p>
                </div>
